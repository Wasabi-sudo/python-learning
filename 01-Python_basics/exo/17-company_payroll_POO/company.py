from employee import Employee, CommissionEmployee, HourlyEmployee, SalaryEmployee
...
def main():
    ...
    employee2 = HourlyEmployee('Toto', 'Smith', 25, 50)
    employee3 = CommissionEmployee('Tata', 'McCarthy', 20000, 5, 200)
